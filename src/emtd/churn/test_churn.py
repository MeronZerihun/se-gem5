...
m5.util.addToPath('../../../configs/') # Add the common scripts to our path
from m5.objects import * # import all of the SimObjects
from caches import *
from common import SimpleOpts # import the SimpleOpts module
...
# Create a simple CPU
#ystem.cpu = TimingSimpleCPU()
system.cpu = MinorCPU()

system.cpu.metadataFileName = 'emtd_test/test.metadata.bin'
...
system.churn = Churn()
system.churn.mem_side = system.membus.slave
